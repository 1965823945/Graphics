...
MainWindow::MainWindow(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::MainWindow),p(this),scale(10)
{
    ui->setupUi(this);

    QString fileName = QFileDialog::getOpenFileName(
            this,
            tr("Выберите файл для входных данных."),
            "E:/",
            tr("(*.txt)"));
...
void MainWindow::paintEvent(QPaintEvent *){
    ...
    Xmin = ui->dsb_Xmin->value(), Ymin = ui->dsb_Ymin->value(),
            Xmax = ui->dsb_Xmax->value(), Ymax = ui->dsb_Ymax->value();
