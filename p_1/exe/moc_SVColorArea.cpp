...
QT_MOC_LITERAL(1, 12, 12), // "sigSvChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 14) // "slotHueChanged"

    },
    "SVColorArea\0sigSvChanged\0\0slotHueChanged"
};
...
void SVColorArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SVColorArea *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigSvChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->slotHueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SVColorArea::*)(int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SVColorArea::sigSvChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SVColorArea::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_SVColorArea.data,
    qt_meta_data_SVColorArea,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void SVColorArea::sigSvChanged(int _t1, int _t2, int _t3)
{
